...
Command: npx gltfjsx@6.2.16 public/models/female.glb -o src/components/Avatarfemale.jsx -r public 
*/
...
import jsonDataWelcome from "../../src/audios/message_static.json"
import jsonDataEdu from "../../src/audios/message_static_edu.json"
...
export function Avatar(props) {
  ...
  const { nodes, materials, scene } = useGLTF('/models/newFemale.glb')
  ...
  useEffect(() => {
    ...
    } else if (playWelcomeChat === 'play-education') {
      playWelcomeAudio(true);
    }
  }, [playWelcomeChat])

  const playWelcomeAudio = async (playEdu) => {
    try {
      let botAnimation = 'Idle'
      let jsonAnimation = playEdu
        ? jsonDataEdu
        : jsonDataWelcome
      let audioAnimation = playEdu
        ? '/src/audios/message_static_edu.mp3'
        : '/src/audios/message_static.mp3'
  ...
  // const playWelcomeAudio2 = async () => {
  //   try {
  //     let botAnimation = 'WavingMale'
  //     let jsonAnimation = hithere
  //     let audioAnimation = '/src/audios/hi-there.mp3'


  //     const audio = await new Audio(audioAnimation);
...
useGLTF.preload('/models/newFemale.glb')
