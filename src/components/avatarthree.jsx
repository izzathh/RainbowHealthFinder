...
Command: npx gltfjsx@6.2.16 public/models/avatarthree.glb -o src/components/avatarthree.jsx -r public 
*/
...
import jsonDataWelcome from "../../src/audios/message_static3.json"
...
export function Avatarthree(props) {
  const { nodes, materials, scene } = useGLTF('/models/avatarthree.glb')
  ...
  const playWelcomeAudio = async () => {
    try {
      ...
      let audioAnimation = '/src/audios/message_static3.mp3'
...
useGLTF.preload('/models/avatarthree.glb')