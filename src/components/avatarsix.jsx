...
Command: npx gltfjsx@6.2.16 public/models/avatarsix.glb -o src/components/avatarsix.jsx -r public 
*/
...
import jsonDataWelcome from "../../src/audios/message_static6.json"
...
export function Avatarsix(props) {
  const { nodes, materials, scene } = useGLTF('/models/avatarsix.glb')
  ...
  const playWelcomeAudio = async () => {
    try {
      ...
      let audioAnimation = '/src/audios/message_static6.mp3'
...
useGLTF.preload('/models/avatarsix.glb')
