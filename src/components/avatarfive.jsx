...
Command: npx gltfjsx@6.2.16 public/models/avatarfive.glb -o src/components/avatarfive.jsx -r public 
*/
...
import jsonDataWelcome from "../../src/audios/message_static5.json"
...
export function Avatarfive(props) {
  const { nodes, materials, scene } = useGLTF('/models/avatarfive.glb')
  ...
  const playWelcomeAudio = async () => {
    try {
      ...
      let audioAnimation = '/src/audios/message_static5.mp3'
...
useGLTF.preload('/models/avatarfive.glb')
