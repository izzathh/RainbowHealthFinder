...
Command: npx gltfjsx@6.2.16 public/models/newGay1.glb -o src/components/avatargay.jsx -r public 
*/
...
import jsonDataWelcome from "../../src/audios/message_static1.json"
...
export function AvatarGay(props) {
  const { nodes, materials, scene } = useGLTF('/models/newGay1.glb')
  ...
  const playWelcomeAudio = async () => {
    try {
      ...
      let audioAnimation = '/src/audios/message_static1.mp3'
...
useGLTF.preload('/models/newGay1.glb')
